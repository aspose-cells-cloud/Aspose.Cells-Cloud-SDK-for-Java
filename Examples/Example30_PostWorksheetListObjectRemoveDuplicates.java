...
public class ExamplePostWorksheetListObjectRemoveDuplicates {
    private  CellsApi api;
    public ExamplePostWorksheetListObjectRemoveDuplicates(){
        try {
            api = new CellsApi(
    ...
    public void Run(){
        try{
            ...
            this.api.postWorksheetListObjectRemoveDuplicates(request);
