...
public class ExamplePostWorksheetCellsRangeColumnWidth {
    private  CellsApi api;
    public ExamplePostWorksheetCellsRangeColumnWidth(){
        try {
            api = new CellsApi(
    ...
    public void Run(){
        try{
            ...
            this.api.postWorksheetCellsRangeColumnWidth(request);
