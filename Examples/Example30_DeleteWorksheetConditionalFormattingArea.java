...
public class ExampleDeleteWorksheetConditionalFormattingArea {
    private  CellsApi api;
    public ExampleDeleteWorksheetConditionalFormattingArea(){
        try {
            api = new CellsApi(
    ...
    public void Run(){
        try{
            ...
            this.api.deleteWorksheetConditionalFormattingArea(request);
