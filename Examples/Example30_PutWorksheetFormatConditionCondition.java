...
public class ExamplePutWorksheetFormatConditionCondition {
    private  CellsApi api;
    public ExamplePutWorksheetFormatConditionCondition(){
        try {
            api = new CellsApi(
    ...
    public void Run(){
        try{
            ...
            this.api.putWorksheetFormatConditionCondition(request);
