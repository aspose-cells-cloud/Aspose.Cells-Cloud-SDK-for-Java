...
public class ExamplePutWorksheetConditionalFormatting {
    private  CellsApi api;
    public ExamplePutWorksheetConditionalFormatting(){
        try {
            api = new CellsApi(
    ...
    public void Run(){
        try{
            ...
            this.api.putWorksheetConditionalFormatting(request);
