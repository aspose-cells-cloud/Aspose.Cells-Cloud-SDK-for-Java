...
public class PostWorksheetMergeRequest implements RequestOption {
    ...
    public PostWorksheetMergeRequest(String name, String sheetName, Integer startRow, Integer startColumn, Integer totalRows, Integer totalColumns) {
    ...
    public PostWorksheetMergeRequest setFolder(String folder) { this.folder = folder; return this; }
    public PostWorksheetMergeRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
