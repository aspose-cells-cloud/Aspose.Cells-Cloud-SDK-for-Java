...
public class SearchContentInRemoteRangeRequest implements RequestOption {
    ...
    public SearchContentInRemoteRangeRequest setIgnoringCase(Boolean ignoringCase) { this.ignoringCase = ignoringCase; return this; }
    public SearchContentInRemoteRangeRequest setFolder(String folder) { this.folder = folder; return this; }
    public SearchContentInRemoteRangeRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
    public SearchContentInRemoteRangeRequest setRegion(String region) { this.region = region; return this; }
    public SearchContentInRemoteRangeRequest setPassword(String password) { this.password = password; return this; }
