...
public class PutWorksheetCellsRangeRequest implements RequestOption {
    ...
    public PutWorksheetCellsRangeRequest setFolder(String folder) { this.folder = folder; return this; }
    public PutWorksheetCellsRangeRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
