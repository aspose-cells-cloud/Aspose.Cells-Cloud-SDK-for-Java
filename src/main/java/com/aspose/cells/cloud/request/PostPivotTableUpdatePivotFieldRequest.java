...
public class PostPivotTableUpdatePivotFieldRequest implements RequestOption {
    ...
    public PostPivotTableUpdatePivotFieldRequest(String name, String sheetName, Integer pivotTableIndex, Integer pivotFieldIndex, String pivotFieldType, PivotField pivotField) {
    ...
    public PostPivotTableUpdatePivotFieldRequest setNeedReCalculate(Boolean needReCalculate) { this.needReCalculate = needReCalculate; return this; }
    public PostPivotTableUpdatePivotFieldRequest setFolder(String folder) { this.folder = folder; return this; }
    public PostPivotTableUpdatePivotFieldRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
    ...
    public String getPath() {
        return "/v3.0/cells/" + urlEncode(name) + "/worksheets/" + urlEncode(sheetName) + "/pivottables/" + urlEncode(String.valueOf(pivotTableIndex)) + "/PivotFields/" + urlEncode(String.valueOf(pivotFieldIndex));
    }
