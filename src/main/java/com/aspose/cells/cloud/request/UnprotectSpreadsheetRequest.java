...
public class UnprotectSpreadsheetRequest implements RequestOption {
    ...
    public UnprotectSpreadsheetRequest(String spreadsheet, String password, String modifyPassword) {
        this(FormFile.ofPath(spreadsheet), password, modifyPassword);
    }

    public UnprotectSpreadsheetRequest(File spreadsheet, String password, String modifyPassword) {
        this(FormFile.of(spreadsheet), password, modifyPassword);
    }

    public UnprotectSpreadsheetRequest(FormFile spreadsheet, String password, String modifyPassword) {
    ...
    public UnprotectSpreadsheetRequest(byte[] spreadsheet, String spreadsheetFileName, String password, String modifyPassword) {
        this(FormFile.of(spreadsheet, spreadsheetFileName), password, modifyPassword);
    }

    public UnprotectSpreadsheetRequest setOutPath(String outPath) { this.outPath = outPath; return this; }
    public UnprotectSpreadsheetRequest setOutStorageName(String outStorageName) { this.outStorageName = outStorageName; return this; }
    public UnprotectSpreadsheetRequest setRegion(String region) { this.region = region; return this; }
