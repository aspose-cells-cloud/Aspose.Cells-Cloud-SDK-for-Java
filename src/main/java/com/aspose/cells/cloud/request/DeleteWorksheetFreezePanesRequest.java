...
public class DeleteWorksheetFreezePanesRequest implements RequestOption {
    ...
    public DeleteWorksheetFreezePanesRequest(String name, String sheetName, Integer row, Integer column, Integer freezedRows, Integer freezedColumns) {
    ...
    public DeleteWorksheetFreezePanesRequest setFolder(String folder) { this.folder = folder; return this; }
    public DeleteWorksheetFreezePanesRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
