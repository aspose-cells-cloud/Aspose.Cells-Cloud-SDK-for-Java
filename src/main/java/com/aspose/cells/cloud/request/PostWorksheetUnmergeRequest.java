...
public class PostWorksheetUnmergeRequest implements RequestOption {
    ...
    public PostWorksheetUnmergeRequest(String name, String sheetName, Integer startRow, Integer startColumn, Integer totalRows, Integer totalColumns) {
    ...
    public PostWorksheetUnmergeRequest setFolder(String folder) { this.folder = folder; return this; }
    public PostWorksheetUnmergeRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
    ...
    public String getPath() {
        return "/v3.0/cells/" + urlEncode(name) + "/worksheets/" + urlEncode(sheetName) + "/cells/unmerge";
    }
