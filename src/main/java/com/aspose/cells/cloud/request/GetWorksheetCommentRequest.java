...
public class GetWorksheetCommentRequest implements RequestOption {
    ...
    public GetWorksheetCommentRequest setFolder(String folder) { this.folder = folder; return this; }
    public GetWorksheetCommentRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
