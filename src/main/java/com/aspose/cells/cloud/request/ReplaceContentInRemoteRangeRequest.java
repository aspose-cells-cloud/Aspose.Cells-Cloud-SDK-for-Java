...
public class ReplaceContentInRemoteRangeRequest implements RequestOption {
    ...
    public ReplaceContentInRemoteRangeRequest setFolder(String folder) { this.folder = folder; return this; }
    public ReplaceContentInRemoteRangeRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
    public ReplaceContentInRemoteRangeRequest setRegion(String region) { this.region = region; return this; }
    public ReplaceContentInRemoteRangeRequest setPassword(String password) { this.password = password; return this; }
    ...
    public String getPath() {
        return "/v4.0/cells/" + urlEncode(name) + "/worksheets/" + urlEncode(worksheet) + "/ranges/" + urlEncode(cellArea) + "/replace/content";
    }
