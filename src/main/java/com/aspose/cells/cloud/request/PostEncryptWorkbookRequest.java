...
/** Excel Encryption. */
public class PostEncryptWorkbookRequest implements RequestOption {
    ...
    public PostEncryptWorkbookRequest setFolder(String folder) { this.folder = folder; return this; }
    public PostEncryptWorkbookRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
