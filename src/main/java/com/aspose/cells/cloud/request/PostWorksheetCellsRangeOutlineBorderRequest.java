...
public class PostWorksheetCellsRangeOutlineBorderRequest implements RequestOption {
    private final String name;
    private final String sheetName;
    private final RangeSetOutlineBorderRequest rangeOperate;
    ...
    public PostWorksheetCellsRangeOutlineBorderRequest setFolder(String folder) { this.folder = folder; return this; }
    public PostWorksheetCellsRangeOutlineBorderRequest setStorageName(String storageName) { this.storageName = storageName; return this; }
