...
public class CellsCloudFileInfoResponse extends CellsCloudResponse {
    ...
    public CellsCloudFileInfoResponse setCode(Integer code) { this.code = code; return this; }

    public String getStatus() { return status; }
    public CellsCloudFileInfoResponse setStatus(String status) { this.status = status; return this; }
