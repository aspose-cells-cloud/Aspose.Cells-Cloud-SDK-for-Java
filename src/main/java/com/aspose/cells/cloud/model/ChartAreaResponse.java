...
public class ChartAreaResponse extends CellsCloudResponse {
    ...
    public ChartAreaResponse setCode(Integer code) { this.code = code; return this; }

    public String getStatus() { return status; }
    public ChartAreaResponse setStatus(String status) { this.status = status; return this; }
